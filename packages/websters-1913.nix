...
stdenv.mkDerivation {
  ...
  src = fetchzip {
    url = "https://github.com/cmod/websters-1913/raw/main/websters-1913.dictionary.zip";
  ...
  meta = with lib; {
    ...
    description = "A contemporary-update to the CSS styling of dictionary results for the Webster's 1913 English Dictionary.";
