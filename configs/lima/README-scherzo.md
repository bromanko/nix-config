...
- `lima-scherzo`: `/nix/store/wh3acblqkilms9qgsws7xqf2vbxkrb9k-nixos-system-lima-scherzo-26.11.20260818.0ae2bc1`
- `lima-scherzo-2`: `/nix/store/3l6dffdyf2jcxbzzyc74gn947h83b7v8-nixos-system-lima-scherzo-2-26.11.20260818.0ae2bc1`

The preceding 0.36.0 deployment could complete its opening handshake but rejected
production assignment offers after the version-1 payload gained `attemptNumber`.
Version 0.38.0 accepted both controlled offers without a service restart, and both
runs began execution. The registrations were returned to draining immediately
after assignment. LIV-2264 continued running; LIV-2284 reached workflow execution
but failed its Linear claim because the ticket was in Triage, independently of the
runner protocol.
