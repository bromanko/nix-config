Run the following script from the workspace root and return the full stdout here.
...
echo ""
echo "💡 Next Actions:"
[ $backlog -gt 0 ] && echo "  • Parse backlog PRDs to epics: /prd-parse <name>"
[ $in_progress -gt 0 ] && echo "  • Check progress on active PRDs: /epic-status <name>"
[ $total -eq 0 ] && echo "  • Create your first PRD: /prd-new <name>"
