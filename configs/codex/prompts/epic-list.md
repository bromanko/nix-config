Run the following command and show me the complete output.
...
[ ! -d ".claude/epics" ] && echo "📁 No epics directory found. Create your first epic with: /prd-parse" && exit 0
[ -z "$(ls -d .claude/epics/*/ 2>/dev/null)" ] && echo "📁 No epics found. Create your first epic with: /prd-parse" && exit 0
