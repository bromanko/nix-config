...
Save the completed PRD to: `.claude/prds/$ARGUMENTS.md` with this exact structure (write the file using `shell` redirection or a short script to avoid partial edits):
