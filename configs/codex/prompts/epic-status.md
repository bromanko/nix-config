...
Get the status of all tasks in an epic
...
When this prompt is triggered, ask the user for the feature name which we will refer to as $1.

Run the following command and show me the complete stdout printed to the console.
