...
## Codex CLI Notes
- Run GitHub CLI commands and filesystem changes with the `shell` tool from the repo root.
- Use the planning tool to track pull/update/push/conflict-resolution phases.
- Rewrite files atomically when applying updates from GitHub.
