...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/v4/dbfl0d1n30j449wtsc2sqqvr0000gp/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/bromanko/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/bromanko/.mailcheckrc"
# }
